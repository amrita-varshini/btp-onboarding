...
|------------------|---------------------|
| **Name**         | Recommended: add the suffix `dt` to the name. <br>For example, follow the naming proposal `<SID><CLIENT>_DT`. |
| **Type**         | `HTTP` |
...
| Property                | Value / Description |
|-------------------------|---------------------|
| **Name**                | We recommend adding the suffix `rt` to the name. <br>For example, follow the naming proposal `<SID><CLIENT>_RT`. |
| **Type**                | `HTTP` |
